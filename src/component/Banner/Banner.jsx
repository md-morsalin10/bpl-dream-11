...
const Banner = () => {
    return (
        <div className='w-11/12 mx-auto py-4'>
            ...
            <div
            className="bg-black rounded-3xl overflow-hidden bg-cover bg-center h-136.25 flex flex-col items-center justify-center text-center space-y-6"
            style={{ backgroundImage: `url(${banner})` }}>
                ...
                <div className='border-2 border-[#E7FE29] p-2 rounded-xl'>
                    <button className='btn bg-[#E7FE29] border-none text-black font-bold'>Claim Free Credit</button>
                </div>
            </div>
        </div>
    );
